...
<script>
    $(document).ready(function () {
		var tabledata = $('#data-table').DataTable({
			"processing": true,
			"ajax": "<?=base_url("ref/post_category/data")?>",
			stateSave: true,
			"order": []
		})
		...
		$('#form-add').on('submit', function () {
			$.ajax({
				type: "POST",
				url: "<?=base_url('ref/post_category/create')?>",
				beforeSend :function () {
					swal({
						title: 'Memproses',
						html: 'Memuat Data',
		...
		$('#data-table').on('click','.row-edit', function () {
			$.ajax({
				type: "POST",
				url: "<?=base_url('ref/post_category/get')?>",
				dataType: "JSON",
				beforeSend :function () {
					swal({
						title: 'Memproses',
		...
		$('#form-edit').on('submit', function () {
			...
			$.ajax({
			type: "POST",
			url: "<?=base_url('ref/post_category/update')?>",
			beforeSend :function () {
				swal({
					title: 'Memproses',
					html: 'Memuat Data',
		...
		$('#data-table').on('click','.row-delete', function () {
			swal({
				...
				switch (value) {
					case "catch":
					$.ajax({
						url:"<?=base_url('ref/post_category/delete')?>",  
						method:"POST",
						beforeSend :function () {
							swal({
								title: 'Memproses',
